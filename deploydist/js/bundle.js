...
module.exports = __webpack_require__(/*! /Users/thanhlai/Senior_Phase/Stackathon/src/main.js */335);
...
var _globals = __webpack_require__(/*! ./globals */ 130);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function initGlobalVariables() {
      this.game.global = (0, _lodash.clone)(_globals2.default);
    }
  }, {
    key: 'preload',
...
var _YellowBrick = __webpack_require__(/*! ../prefabs/YellowBrick */ 345);

var _YellowBrick2 = _interopRequireDefault(_YellowBrick);
...
var _class = function (_State) {
  ...
  _createClass(_class, [{
    ...
    key: 'setUpYellowBricks',
    value: function setUpYellowBricks() {
    ...
    value: function setUpPaddle() {
      this.paddle = new _Paddle2.default(this.game, this.game.world.centerX, this.game.world.height - 50);
    ...
    key: 'putBallInPaddle',
    value: function putBallInPaddle() {
      this.ballOnPaddle = true;
      this.ball.reset(this.paddle.body.x, this.paddle.y - this.paddle.body.height - 25);
    }
  }, {
    key: 'generateYellowBricks',
    value: function generateYellowBricks(inputRows, inputColumns, inputXOffset, inputYOffset) {
      var rows = inputRows;
      var columns = inputColumns;
      var xOffset = inputXOffset;
      var yOffset = inputYOffset;
      var yellowBrick = void 0;
      for (var y = 0; y < rows; y++) {
        for (var x = 0; x < columns; x++) {
          yellowBrick = new _YellowBrick2.default(this.game, x * xOffset, y * yOffset);
          this.yellowBrick.add(yellowBrick);
        }
      }
      var bricksGroupWidth = (xOffset * columns - (yOffset - yellowBrick.width)) / 2;
      this.yellowBrick.position.setTo(this.game.world.centerX - bricksGroupWidth, this.game.world.centerY - 350);
    }
  }, {
    key: 'createText',
    value: function createText(xOffset, yOffset, text, font, color, align) {
      return this.game.add.text(xOffset, yOffset, text, {
        font: font,
        fill: color,
        boundsAlignH: align }).setTextBounds(0, 0, this.game.world.width, 0);
    }
  }, {
    key: 'update',
    value: function update() {
      ...
      this.game.physics.arcade.collide(this.ball, this.yellowBrick, this.ballHityellowBrick, null, this);
    }
  }, {
    key: 'ballHitPaddle',
    ...
    key: 'ballHityellowBrick',
    value: function ballHityellowBrick(ball, brick) {
      this.ball.body.velocity.x = Math.floor(Math.random() * (200 - 100) + 100);
      brick.kill();
...
var YellowBrick = function (_Sprite) {
  _inherits(YellowBrick, _Sprite);

  function YellowBrick(game, x, y) {
    _classCallCheck(this, YellowBrick);

    var _this = _possibleConstructorReturn(this, (YellowBrick.__proto__ || Object.getPrototypeOf(YellowBrick)).call(this, game, x, y, 'yellowBrick'));
...
var Paddle = function (_Sprite) {
  _inherits(Paddle, _Sprite);
